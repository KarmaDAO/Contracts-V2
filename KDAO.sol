...
contract KDAO is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 58954779705000;
    //    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 58954779705000;

    uint256 public liquidityFee = 500;
    uint256 public Treasury = 400;
    ...
    uint256 private constant TOTAL_GONS = (MAX_UINT256 - (MAX_UINT256 % INITIAL_FRAGMENTS_SUPPLY)) / 10000;
    ...
    constructor() ERC20Detailed("KDAO", "KDAO", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xb70b93920BF88d27F0A2C44c0D5765B6E962daa3;
        TreasuryReceiver = 0xfDb6b8c522d9c0117b19E2C01a9A33EB78edf9Cf;
        RiskFreeValueReceiver = 0xDBEa8292F15719e7b577d000d8a6d82915377685;
    ...
    function swapBack() internal swapping {
        ...
        if(dynamicLiquidityFee > 0) amountToLiquify = contractTokenBalance.mul(dynamicLiquidityFee).div(totalFee).div(2);
